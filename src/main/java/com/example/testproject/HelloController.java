...
public class HelloController implements Initializable {
    ...
    private void createAccount() {
        if (txtEmail.getText().trim().isEmpty() || R_txtUsername.getText().trim().isEmpty() || R_txtPassword.getText().trim().isEmpty() || txtPhone.getText().trim().isEmpty() || R_txtLoginUsername.getText().trim().isEmpty()){
            ...
            try {
                usuariosDatos.insertarUsuario(R_txtUsername.getText().trim(), R_txtLoginUsername.getText().trim(), R_txtPassword.getText().trim(), txtPhone.getText().trim(), txtEmail.getText().trim());
